...
export const getTasks = async (req, res) => {
    try {
        ...
        const result = await pool.request().query("SELECT * from Nexttasks");
...
export const getTask = async (req, res) => {
    try {
        ...
        const result = await pool.request()
            ...
            .query("SELECT * FROM Nexttasks WHERE Task_id = @Task_id");
...
export const deleteTask = async (req, res) => {
    try {
        ...
        await sql.query`DELETE FROM Nexttask WHERE task_id = ${id}`;
