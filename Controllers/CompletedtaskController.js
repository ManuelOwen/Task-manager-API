...
export const getTasks = async (req, res) => {
    try {
        ...
        const result = await pool.request().query("SELECT * from Completedtasks");
...
export const getTask = async (req, res) => {
    try {
        ...
        const result = await pool.request()
            ...
            .query("SELECT * FROM Completedtasks WHERE Task_id = @Task_id");
...
export const deleteTask = async (req, res) => {
    try {
        ...
        await sql.query`DELETE FROM Completedtasks WHERE id = ${id}`;
